...
int main(void) {
  ...
  // Register a handler at address "/varargs" with variable length of arguments
  enum ApiResult res =
      hi_register_handler_where_less_args_are_ok(serv, "/vararg", "iii", generic_callback, NULL);
